function [W, H, HIS] = SSNMFFro(V, opts)
...
for i = 1:maxIter,
    ...
    [W, iterW] = doSSNQP(HH, VH,  W, labels, maxIterW, tolW, 0, maxNumberThreads, classNumber, opts.penalty);
    %fprintf('Learing: %.4E\n\n', norm(V-W*H, 'fro')^2);
    ...
    [H, iterH] = doNQP(WW, VW, H, maxIterH, tolH, 0, maxNumberThreads);
