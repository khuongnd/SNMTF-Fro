...
typedef void (*Optimizer)(double** H, double *h, int k, double tolorance, 
        int maxIter, int verbose, double *x, 
        double* iter, double *stopMax, double* sqrtH);
...
void FrankWolfe(double** H, double *h, int k, double tolorance, int maxIter, int verbose,
